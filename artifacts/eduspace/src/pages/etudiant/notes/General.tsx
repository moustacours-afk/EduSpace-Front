  ...
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-sm text-muted-foreground">Moyenne semestre : <span className="font-bold text-foreground">{moy}</span></span>
      </div>
      ...
      <div className="mt-3 px-5 py-3 bg-muted/30 rounded-xl border border-border/50 flex items-center justify-between text-sm">
        ...
        <span className={`font-bold text-base ${parseFloat(moy) >= 10 ? "text-green-600" : "text-red-500"}`}>{moy} / 20</span>
      </div>
    </div>
  );
}
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4 p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl">
            <div className="flex-1">
              ...
              <p className="text-3xl font-extrabold text-blue-700">{moyGenerale}<span className="text-base font-normal text-blue-400"> / 20</span></p>
            </div>
